...
class NGram:
    ...
    def __init__(self, data_frame, n, regex=constants.REGEX_ALL_SPECIAL_ALPHA_NUMERIC):
        ...
        self.data_frame = utilities.tokenizer(regex, data_frame)
        self.n = n
        self.regex = regex
        self.grams = None
        self.starts = None
    ...
    def predict(self, words):
        ...
        if isinstance(words, int):
            ...
            words = tuple(utilities.tokenizer(self.regex, words))[-self.n:]
